...
if($conn->connect_error) {
    die("medey2 .. DBerror" . $conn->connect_error);
}
else
{
    $queryInsert = "INSERT INTO USERS(UserName,UserPwd,UserType)
...
<div id='card' class="animated fadeIn">
  ...
  <div id='lower-side'>
    ...
    <a href="/Group Project/Login Page/login.html" id="contBtn">Continue</a>
  </div>
</div>
</body>
</html>
