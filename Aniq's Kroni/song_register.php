...
{
	$queryInsert = "INSERT INTO songs (songTitle, artistName, songMedia, genre, language, releaseDate, otherDetails)
        VALUES ('$songTitle', '$artistName', '$songMedia', '$genre', '$language', '$releaseDate', '$otherDetails')";
